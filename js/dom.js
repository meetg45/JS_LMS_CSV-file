...
export const colSelection = document.getElementById("colSelection");
export const showHeaderPanel = document.getElementById("showHeaderPanel");
export const showPagination = document.getElementById("pagination");
